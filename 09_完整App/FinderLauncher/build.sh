...
#
# 构建产物：
#   build/Build/Products/<配置>/FinderLauncher.app
# ============================================================
...
PROJECT="$SCRIPT_DIR/FinderLauncher.xcodeproj"
...
echo "🔨 开始构建 FinderLauncher（$CONFIG）..."
...
#   build/Build/Products/<Debug|Release>/FinderLauncher.app
# ------------------------------------------------------------
APP_PATH="$SCRIPT_DIR/build/Build/Products/$CONFIG/FinderLauncher.app"
