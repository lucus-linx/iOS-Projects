//
//  LXLogSandbox_GCDWebServerVC.m
//  LXLogViewPods
//
//  Created by linxiang on 2018/5/22.
...
@interface LXLogSandbox_GCDWebServerVC ()
@property (nonatomic, strong) WKWebView * wkWebView;

@property (nonatomic, strong) GCDWebUploader * webUploader;
@end

@implementation LXLogSandbox_GCDWebServerVC
...
- (void)viewDidLoad {
    ...
    _wkWebView = [[WKWebView alloc] initWithFrame:CGRectMake(0, 0, screenW, screenH - 20 - 44)];//self.view.bounds
    //新特性，解决偏移的问题
