...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        ...
        SFOperation *sfOperation_1 = [SFFactory operationBreakfast:SFFactoryProductTypeYoutiao];
        [sfOperation_1 productBreakfast];
        NSLog(@"sfOperation_1 生产产品:%@",sfOperation_1.product);
