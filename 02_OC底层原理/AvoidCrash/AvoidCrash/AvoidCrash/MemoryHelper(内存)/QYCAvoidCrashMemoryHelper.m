...
@implementation QYCAvoidCrashMemoryHelper
...
- (NSString *)appTotalMemory {
    ...
    NSString *totalStr = [self number2String:total];
    return [NSString stringWithFormat:@"%@", totalStr];
}
