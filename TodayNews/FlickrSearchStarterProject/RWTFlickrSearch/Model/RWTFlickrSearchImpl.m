...
- (instancetype)init {
    self = [super init];
    if (self) {
        NSString *OFSampleAppAPIKey = @"45a4251dc1a3c9934f8ff8da7a8216ee"; //@"7663b22d7e13473c2af8b49d8d09f36f";// @"adc52c6f6bf8166d95f4c459f851e2c6";
        NSString *OFSampleAppAPISharedSecret = @"f7d45ce1c8b4bf8d"; //@"2601c8fb1a63bef4";   //@"0c390376580389b5";
